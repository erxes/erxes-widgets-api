...
describe('Mutations', () => {
  describe('messengerConnect', () => {
    ...
    afterEach(done => {
      ...
      expectPromise(done, Promise.all([p1, p2, p3, p4, p5]), () => {
        done();
      });
    });
    ...
    describe('first time', () => {
      ...
      it('first time', done => {
        // call mutation
        expectPromise(done, messengerMutations.messengerConnect({}, { brandCode, email }), res => {
          ...
          expectPromise(done, Promise.all([p1, p2]), () => {
            done();
          });
        });
      });
    ...
    describe('second time', () => {
      ...
      it('second time', done => {
        ...
        expectPromise(done, messengerMutations.messengerConnect({}, { brandCode, email }), res => {
          ...
          expectPromise(done, Promise.all([p1]), () => {
            done();
          });
        });
      });
  ...
  describe('messenger insert message', () => {
    ...
    describe('first time', () => {
      ...
      it('first time', done => {
        ...
        // call mutation
        expectPromise(done, messengerMutations.insertMessage({}, args), messageObj => {
